...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')) {
        ...
        const finalText = "I am fine friend tell me how can i help you";
        speech.text = finalText;
    }

    else if(message.includes('bye')) {
        const finalText = "bye bye friend";
        speech.text = finalText;
    }

    else if(message.includes('papa')) {
        const finalText = " heyppee badday";
        speech.text = finalText;
    }

    // else if(message.includes('ishita love')) {
    //     const finalText = " vanshu";
    //     speech.text = finalText;
    // }
